const Page = () => (
  <div className="w-full max-w-xl space-y-4">
    ...
    <p>Welcome to Adventures by Alexx!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Alex Development&apos;s Website, located at
      https://adventuresbyalex.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Adventures by Alexx if you do not agree to take all
    ...
    <p>
      ...
      prevailing law of af. Any use of the above terminology or other words in
    ...
    <p>
      ...
      to use cookies in agreement with the Alex Development&apos;s Privacy
      Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Alex Development and/or its licensors own the
      intellectual property rights for all material on Adventures by Alexx. All
      intellectual property rights are reserved. You may access this from
      Adventures by Alexx for your own personal use subjected to restrictions
      set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Adventures by Alexx</li>
      <li>Sell, rent or sub-license material from Adventures by Alexx</li>
      <li>Reproduce, duplicate or copy material from Adventures by Alexx</li>
      <li>Redistribute content from Adventures by Alexx</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Alex Development
      does not filter, edit, publish or review Comments prior to their presence
      on the website. Comments do not reflect the views and opinions of Alex
      Development,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Alex Development shall not be liable for the
    ...
    <p>
      Alex Development reserves the right to monitor all Comments and to remove
    ...
    <p>
      You hereby grant Alex Development a non-exclusive license to use,
    ...
    <p>
      ...
      hyperlink compensates the absence of Alex Development; and (d) the link is
    ...
    <p>
      ...
      e-mail to Alex Development. Please include your name, your organization
    ...
    <p>
      No use of Alex Development&apos;s logo or other artwork will be allowed

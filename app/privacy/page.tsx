const Page = () => (
  <div className="w-full max-w-xl space-y-4">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Adventures by Alexx.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Adventures by Alexx, accessible
          from{" "}
          <a
            href="https://adventuresbyalexx.com"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://adventuresbyalexx.com
          </a>
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: a.legal.contact@gmail.com</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:{" "}
          <a
            href="https://adventuresbyalexx.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://adventuresbyalexx.com/contact
          </a>
        </p>
      </li>
    </ul>
